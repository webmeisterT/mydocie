...
$column = "patient_id, details, type_of_insurance";
$value = ":patient_id, :details, :type_of_insurance";
    
    // Create client
$response = $create_record->create("insurance_records",$column,$value,$new_data);
