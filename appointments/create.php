...
$column = "patient_id, doctor_id, appointed_date, appointed_time, appointed_type";
$value = ":patient_id, :doctor_id, :appointed_date, :appointed_time, :appointed_type";

    // Create client
$response = $create_record->create("appointments",$column,$value,$new_data);
