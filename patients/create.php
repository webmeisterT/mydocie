...
$response = $read_one->read("*", "patients", "username=:username OR email=:email OR phone=:phone", ['username' => $new_data['username'], 'email' => $new_data['email'], 'phone' => $new_data['phone']]);
...
$value = ":first_name, :last_name, :username, :email, :phone, :password";
    ...
    // Create client
$response = $create_record->create("patients",$column,$value,$new_data);
