...
$column = "patient_id, doctor_id, drug_name, dosage, duration, repeat_drug, day_time, diet_type, diagnosis, doctor_note";
$value = ":patient_id, :doctor_id, :drug_name, :dosage, :duration, :repeat_drug, :day_time, :diet_type, :diagnosis, :doctor_note";

// Create client
$response = $create_record->create("prescriptions",$column,$value,$new_data);
